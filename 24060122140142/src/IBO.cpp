...
public:
    ...
    void start()
    {
        ...
        float positions[] = {
            ...
            0.3f, 0.f, 1.0, 0.0, 1.0,  // A1 - Purple
            0.f, -0.3f, 1.0, 1.0, 0.0, // A2 - Yellow
            -0.3f, 0.f, 1.0, 0.0, 0.0, // A3 - Red
            0.f, 0.3f, 0.0, 0.0, 1.0,  // A4 - Blue
            0.5f, 0.f, 0.0, 1.0, 0.0,  // A5 - Green
            0.f, -0.5f, 0.0, 1.0, 1.0, // A6 - Blue
            -0.5f, 0.f, 0.0, 1.0, 0.0, // A7 - Green
            0.f, 0.5f, 0.0, 1.0, 0.0,  // A8 - Green
            0.8f, 0.f, 1.0, 0.0, 1.0,  // A9 - Purple
            0.f, -0.8f, 0.0, 0.0, 1.0, // A10 - Blue
            -0.8f, 0.f, 0.0, 0.0, 1.0, // A11 - Blue
            0.f, 0.8f, 1.0, 1.0, 0.0   // A12 - Yellow
        };
